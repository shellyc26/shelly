...
> Gamification ideas for Chapter 8: Performance on student work in the achieving things, are you a coder or hacker, and chapter exercises in this chapter could be included as part of earning a continuous data analysis badge. Combine scores from this chapter and chapters 6, 7, 10, and 11. Set thresholds for earning a bronze, silver, or gold badge. Integrate badge earnings into Blackboard or other platforms students use to share their portfolios and achievements with prospective employers or degree programs. Conduct an R graphing challenge where students have to answer a research question in a short presentation without talking and using only graphs. Award points for clear and appropriate graphs, good storytelling, use of multiple graph types, use of unusual graph types (e.g., maps), and graph formatting skills.
