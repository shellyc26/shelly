...
For ordinal categorical variables, a model is needed that can account for the order of the outcome variable. Leslie looks over the job satisfaction variables and decides to apply the ordinal regression model to the salary satisfaction variable. 
